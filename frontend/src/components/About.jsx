...
export default function About() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[80vh] bg-gray-900 rounded-xl shadow-lg p-8 mx-auto max-w-2xl mt-10">
            {/* Profile Section */}
            <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-yellow-400 mb-4">
                <img
                    src="https://avatars.githubusercontent.com/u/102982010?v=4"
                    alt="Sujal Patel"
            ...
            {/* Name and Title */}
            <h2 className="text-3xl font-bold text-yellow-400 mb-1">Sujal Patel</h2>
            <p className="text-gray-300 text-xl mb-4">Full Stack Developer</p>
            ...
            <div className="w-full mb-8">
                <h3 className="text-xl font-semibold text-yellow-400 mb-4 text-center">Technical Skills</h3>
                <div className="flex flex-wrap justify-center gap-2">
                    {skills.map((skill, index) => (
                        <span
                            key={index}
                            className="px-3 py-1 bg-gray-800 text-gray-300 rounded-full text-sm hover:bg-yellow-400 hover:text-gray-900 transition-colors"
                        >
                            {skill}
                        </span>
                    ))}
